...
<body class="container">
    ...
    <form action="" method="POST" novalidate="novalidate">
        <div class="mb-3">
            ...
            <input type="text" class="form-control <?= isset($article) && $article['titre'] === '' ? 'is-invalid' : '' ?>" id="titre" name="titre" required value="<?= $article['titre'] ?? '' ?>">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control <?= isset($article) && $article['contenu'] === '' ? 'is-invalid' : '' ?>" id="contenu" name="contenu" rows="3" required><?= $article['contenu'] ?? '' ?></textarea>
            <div class="invalid-feedback">
